...
from .models import (
    ...
    TenderCompanyItem, TenderingCompanies, Tender, User, DrawingDetails, Log, Reminder, Todo
)
...
app.include_router(tender_company_item.router, prefix="/api/tender_company_items")
